...
def str_combo(name: str,
			  current_option: str,
			  options: Sequence[str]) -> IMGui[Tuple[bool, str]]:
...
def str_combo_with_none(name: str,
			  			...
			  			nothing_text=NOTHING_SELECTED_TEXT) -> IMGui[Tuple[bool, Optional[str]]]:
	...
	changed, selected_str = str_combo(name, current_option_text, [nothing_text] + options)
