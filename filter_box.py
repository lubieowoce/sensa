...
def has_filter_box_filter(filter_box_state: Dict[str, Any]) -> bool:
...
def is_filter_box_full(filter_box_state: Dict[str, Any]) -> bool:
	return is_filter_box_connected(filter_box_state) \
		   and has_filter_box_filter(filter_box_state) \
...
def update_filter_box(filter_box_state: Dict[str, Any], signal_data: Dict[str, Signal]) -> IO_[None]:
	...
	elif not has_filter_box_filter(filter_box_state) and FILTER_BOX_OUTPUT_SIGNAL_ID in signal_data:
