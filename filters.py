...
def butter_lowpass_coeffs(cutoff_freq: float, sampling_freq, type: str, order=5) -> Tuple[Sequence[float], Sequence[float]]:
...
def simple_filter_raw(data: Sequence[float], cutoff_freq: float, sampling_freq, type: str, order=5) -> Sequence[float]:
